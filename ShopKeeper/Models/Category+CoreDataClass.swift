...
//            self.setValue(categoryId, forKey: "id")
//        }
        if let childCat = data["child_categories"] as? [Int]{
            self.setValue(childCat, forKey: "child_categories")
        }else{
            //self.setValue([], forKey: "child_categories")
        }
        ...
        if let products = data["products"] as? [[String: Any]] {
            ...
            if products.count == 0{
//                    if let child = self.value(forKey: "child_categories") as? [Int]{
//                        print("got it")
//                    }
            }else{
                _ = products.map{
